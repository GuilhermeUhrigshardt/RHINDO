 ...
 * @author guilh
 */
@WebServlet(name = "RelatoriosGerente", urlPatterns = {"/RelatoriosGerente"})
public class RelatoriosGerente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException, ClassNotFoundException, JRException {
        ...
        if (request.getParameter("rel") == null) {
            ...
            RequestDispatcher rd = getServletContext().getRequestDispatcher("/manter_relatorios.jsp");
            rd.forward(request, response);
        }
            ...
            try {
                ...
                con = DriverManager.getConnection("jdbc:mysql://localhost/rhindo", "root", "");
